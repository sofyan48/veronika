...
// Veronika ...
type Veronika struct{}

// VeronikaHandler ...
func VeronikaHandler() *Veronika {
	return &Veronika{}
}

// VeronikaInterface ...
type VeronikaInterface interface {
	dataProviderOutput() *dataProvider
	Checker(msisdn string) (*dataProvider, string)
}
...
// dataProviderOutput ...
func (vero *Veronika) dataProviderOutput() *dataProvider {
	return &dataProvider{}
}

// Checker ...
func (prv *Veronika) Checker(msisdn string) (*dataProvider, string) {
